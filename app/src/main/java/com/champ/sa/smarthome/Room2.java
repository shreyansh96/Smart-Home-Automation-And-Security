        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (button2.isChecked()) {
                    Toast.makeText(Room2.this, "Fan ON!", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(Room2.this, "Fan OFF!", Toast.LENGTH_LONG).show();
                }
            }
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (button3.isChecked()) {
                    Toast.makeText(Room2.this, "Air conditioning ON!", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(Room2.this, "Air conditioning OFF!", Toast.LENGTH_LONG).show();
                }
            }
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (button4.isChecked()) {
                    Toast.makeText(Room2.this, "Automatic sensing ON!", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(Room2.this, "Automatic sensing OFF!", Toast.LENGTH_LONG).show();
                }
            }
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (button5.isChecked()) {
                    Toast.makeText(Room2.this, "Night Lamp ON!", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(Room2.this, "Night Lamp OFF!", Toast.LENGTH_LONG).show();
                }
            }
